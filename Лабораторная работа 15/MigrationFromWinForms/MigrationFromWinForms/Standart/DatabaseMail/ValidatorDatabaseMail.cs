...
using MigrationFromWinForms.Properties;
using TextBox = System.Windows.Controls.TextBox;

namespace MigrationFromWinForms.Standart.DatabaseMail
{
    class ValidatorDatabaseMail
    {
        ...
        public static void AnalyValid(System.Windows.Forms.TextBox textBox, bool validVal, string errorMsg, ErrorProvider error)
        {
            if (!validVal)
            {
        ...
        public static void AnalyValid(TextBox textBox, bool validVal, string errorMsg, ErrorProvider error)
        {
            if (!validVal)
            {
                textBox.Select(0, textBox.Text.Length);
        ...
        public static void ValidatingTextBox(TextBox textBox, out bool validVal, ErrorProvider error)
        {
            string errorMsg;
            validVal = ValidSimpleString(textBox.Text, out errorMsg);

            AnalyValid(textBox, validVal, errorMsg, error);
        }

        public static void ValidatingTextBox(System.Windows.Forms.TextBox textBox, out bool validVal, ErrorProvider error)
        {
            string errorMsg;
            validVal = ValidSimpleString(textBox.Text, out errorMsg);
